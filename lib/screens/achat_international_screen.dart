...
class AchatInternationalScreen extends StatefulWidget {
  final String myNumber;
  final String token;

  const AchatInternationalScreen({
    super.key,
  ...
  @override
  State<AchatInternationalScreen> createState() => _AchatInternationalScreenState();
}

class _AchatInternationalScreenState extends State<AchatInternationalScreen> {
  ...
  Future<void> _loadPasses() async {
    ...
    try {
      final passes = await ApiService.getPassInternational(widget.token);
      setState(() {
  ...
  void _goToConfirmation() async {
    ...
    if (_selectedPass == null) {
      setState(() {
        _errorMessage = "Veuillez sélectionner un pass international dans la liste.";
      });
      return;
    }
  ...
  void _showConfirmationDialog() {
    ...
    final bool canConfirm = isWalletSufficient;
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: selectedPaymentSource == "PRINCIPAL"
                        ...
                        border: Border.all(
                          color: selectedPaymentSource == "PRINCIPAL"
                              ? orangeColor
                              : (isWalletSufficient ? Colors.white24 : Colors.white12),
                          width: selectedPaymentSource == "PRINCIPAL" ? 1.5 : 0.8,
                        ),
                      ),
                      child: Row(
                        children: [
                          Icon(
                            ...
                            color: isWalletSufficient ? orangeColor : Colors.white24,
                            size: 20,
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "Compte principal (Solde: ${(_currentWalletBalance ?? 0.0).toStringAsFixed(0)} F CFA)",
                                  style: TextStyle(
                                    color: isWalletSufficient ? Colors.white : Colors.white38,
                                    fontSize: 13,
  ...
  void _confirmPurchase(StateSetter setDialogState, String paymentSource) async {
    ...
    try {
      await ApiService.purchasePassInternational(
            ...
            child: categoryPasses.isEmpty
                ...
                : Column(
                    children: categoryPasses.map((pass) {
                      ...
                      final durationText = "$minutes min d'appels";
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              // Right column: Public globe icon & minutes
                              Column(
                                children: [
