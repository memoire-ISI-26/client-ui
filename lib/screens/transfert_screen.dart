...
class _TransfertScreenState extends State<TransfertScreen> {
  ...
  void _goToConfirmation() async {
    ...
    final String receiver = _recipientController.text.trim();
    if (receiver == widget.myNumber) {
      setState(() {
        _errorMessage = "Vous ne pouvez pas effectuer un transfert vers votre propre numéro.";
      });
      return;
    }
  ...
  void _showConfirmationDialog() {
    ...
    final double expectedFinalSolde = (_currentWalletBalance ?? 0.0) - amount;
    final bool isWalletSufficient = (_currentWalletBalance ?? 0.0) >= amount;
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  _buildInfoRow("Bénéficiaire", _recipientController.text.trim()),
                  _buildInfoRow("Montant du transfert", "${amount.toStringAsFixed(0)} F CFA"),
                  _buildInfoRow("Solde restant estimé", "${expectedFinalSolde.toStringAsFixed(2)} F CFA"),
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: (_isSubmitting || !isWalletSufficient)
                            ? null
                            : () => _confirmTransfer(setDialogState),
  ...
  void _confirmTransfer(StateSetter setDialogState) async {
    setDialogState(() {
      _isSubmitting = true;
      _errorMessage = null;
    });
    ...
    try {
      ...
      ApiService.sendDqnReward(
        ...
        serviceId: "OMY.SERVICES.TRANSFERT",
        reward: 1.0,
        token: widget.token,
