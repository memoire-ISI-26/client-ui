...
class _DepositScreenState extends State<DepositScreen> {
  ...
  void _showConfirmationDialog() {
    ...
    final double expectedFinalBalance = initialBalance + depositAmount;
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              title: const Row(
                children: [
                  Icon(Icons.add_circle_outline_rounded, color: Colors.greenAccent, size: 26),
                  SizedBox(width: 10),
                  Text(
              ...
              content: Column(
                ...
                children: [
                  ...
                  _buildInfoRow("Bénéficiaire", widget.myNumber),
                  _buildInfoRow("Type d'opération", "Dépôt d'argent"),
                  _buildInfoRow("Montant à déposer", "${depositAmount.toStringAsFixed(0)} F CFA"),
                  const Divider(color: Colors.white12, height: 24),
                  _buildInfoRow("Solde actuel", "${initialBalance.toStringAsFixed(2)} F CFA"),
                  _buildInfoRow("Solde après dépôt", "${expectedFinalBalance.toStringAsFixed(2)} F CFA"),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: _isSubmitting
                            ? null
                            : () => _confirmDeposit(setDialogState, depositAmount),
  ...
  void _confirmDeposit(StateSetter setDialogState, double amount) async {
    setDialogState(() {
      _isSubmitting = true;
      _errorMessage = null;
    });
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // 2. Amount field
                const Text(
                  "Saisir le montant du dépôt (F CFA)",
                  style: TextStyle(color: Colors.white70, fontSize: 14, fontWeight: FontWeight.bold),
                ),
                const SizedBox(height: 8),
                Container(
